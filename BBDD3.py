#V57 BBDD2 GESTIONAR LAS CLAVES PRIMARY DE LA BBDD
...
miCursor.execute("CREATE TABLE PRODUCTOS (ID INTEGER PRIMARY KEY AUTOINCREMENT, NOMBRE_ARTICULO VARCHAR(50), PRECIO INTEGER, SECCION VARCHAR(20))")
